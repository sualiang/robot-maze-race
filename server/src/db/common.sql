...
CREATE INDEX idx_operators_registry_operator_id ON operators_registry(operator_id);
...
CREATE INDEX idx_admin_users_operator ON admin_users(operator_id);
...
CREATE INDEX idx_season_user_info_user ON season_user_info(user_id);
CREATE INDEX idx_season_user_info_season ON season_user_info(season_id);
...
CREATE INDEX idx_combat_power_user ON combat_power(user_id);
...
CREATE INDEX idx_helps_initiator ON helps(initiator_id);
...
CREATE INDEX idx_help_helpers_help ON help_helpers(help_id);
CREATE INDEX idx_help_helpers_user ON help_helpers(user_id);
...
CREATE INDEX idx_notification_logs_scene ON notification_logs(scene);
...
CREATE INDEX idx_operator_members_phone ON operator_members(phone);
...
CREATE INDEX idx_settlements_operator ON settlements(operator_id);
